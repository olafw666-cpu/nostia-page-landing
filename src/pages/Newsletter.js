        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-lg overflow-hidden">
              <iframe
                src="https://www.linkedin.com/embed/feed/update/urn:li:activity:7425180154307608576"
                width="100%"
                height="400"
                frameBorder="0"
                allowFullScreen
            ...
            <div className="rounded-lg overflow-hidden">
              <iframe
                src="https://www.linkedin.com/embed/feed/update/urn:li:activity:7422998276909481984"
                width="100%"
                height="400"
                frameBorder="0"
                allowFullScreen
                title="Launching Nostia on Android"
              ></iframe>
            </div>
            <div className="rounded-lg overflow-hidden">
              <iframe
                src="https://www.linkedin.com/embed/feed/update/urn:li:activity:7420812658528030720"
                width="100%"
                height="400"
                frameBorder="0"
                allowFullScreen
            ...
            <div className="rounded-lg overflow-hidden">
              <iframe
                src="https://www.linkedin.com/embed/feed/update/urn:li:activity:7410823713887236096"
                width="100%"
                height="400"
                frameBorder="0"
                allowFullScreen
